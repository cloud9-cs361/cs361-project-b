...
/**
 * Get the account's collection for this Application, which will be a list of
 * all accounts in all account stores that are mapped to this application.
 *
 ...
 * `givenName`, `middleName`, `surname`, `username`, `email`, `status`,
