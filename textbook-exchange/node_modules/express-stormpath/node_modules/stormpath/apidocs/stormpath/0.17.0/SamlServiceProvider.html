...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: SamlServiceProvider</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: SamlServiceProvider</h1>
...
<article>
    ...
    <h4 class="name" id="SamlServiceProvider"><span class="type-signature"></span>new SamlServiceProvider<span class="signature">(samlServiceProviderData)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Encapsualtes the SAML Service Provider of an <a href="Application.html">Application</a>. For more
...
from <a href="SamlPolicy.html#getServiceProvider">SamlPolicy.getServiceProvider()</a></p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>samlServiceProviderData</code></td>
...
<span class="param-type">String</span>
        ...
        <tr>
                ...
                <td class="name"><code>ssoInitiationEndpoint</code></td>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The URL for initiating the redirect to the SAML IdP.  Please refer to
<a href="https://docs.stormpath.com/rest/product-guide/latest/auth_n.html#the-stormpath-saml-flow">The Stormpath SAML Flow</a>.</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="resource_SamlServiceProvider.js.html">resource/SamlServiceProvider.js</a>, <a href="resource_SamlServiceProvider.js.html#line6">line 6</a>
    </li></ul></dd>
