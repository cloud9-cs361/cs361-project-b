...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: SamlPolicy</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: SamlPolicy</h1>
...
<article>
    ...
    <h4 class="name" id="SamlPolicy"><span class="type-signature"></span>new SamlPolicy<span class="signature">(samlPolicyData)</span><span class="type-signature"></span></h4>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The time this resource was created, ISO 8601 format.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The HREF of this REST resouce.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The HREF of the linked <a href="SamlServiceProvider.html">SamlServiceProvider</a> resource.</p></td>
        </tr>
...
<dl class="details">
    ...
    <h4 class="name" id="getServiceProvider"><span class="type-signature"></span>getServiceProvider<span class="signature">(getResourceOptions<span class="signature-attributes">opt</span>, callback)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Get the <a href="SamlServiceProvider.html">SamlServiceProvider</a> resource of this SAML Policy resouce.</p>
</div>
...
<span class="param-type">function</span>
            ...
            <td class="description last"><p>Callback function, will be called with (err, <a href="SamlServiceProvider.html">samlServiceProvider</a>).</p></td>
        </tr>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="resource_SamlPolicy.js.html">resource/SamlPolicy.js</a>, <a href="resource_SamlPolicy.js.html#line49">line 49</a>
    </li></ul></dd>
