...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: PasswordResetToken</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: PasswordResetToken</h1>
...
<article>
    ...
    <h4 class="name" id="PasswordResetToken"><span class="type-signature"></span>new PasswordResetToken<span class="signature">(passwordResetTokenResource)</span><span class="type-signature"></span></h4>
...
<div class="description">
    <p>Encapsulates a Password Reset Token Resource</p>
</div>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>passwordResetTokenResource</code></td>
...
an applications <code>/passwordResetTokens</code> endpoint.</p></td>
        </tr>
...
<span class="param-type">Object</span>
            ...
            <td class="description last"><p>The HREF of the <a href="Account.html">Account</a> of the email address.</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The email address that this token was sent to</p></td>
        </tr>
...
<span class="param-type">String</span>
            ...
            <td class="description last"><p>The HREF of the token resource</p></td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="resource_PasswordResetToken.js.html">resource/PasswordResetToken.js</a>, <a href="resource_PasswordResetToken.js.html#line22">line 22</a>
    </li></ul></dd>
